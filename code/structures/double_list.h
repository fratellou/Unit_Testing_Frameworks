...
public:
    ...
    DoubleNode* prev;
    DoubleNode* next;
    DoubleNode(const string& data) : element(data), prev(nullptr), next(nullptr) {}
};
...
public:
    ...
    ~DoubleLinkedList() {
        while (head != nullptr) {
            ...
            // Delete the node, which will invoke the DoubleNode destructor and free the string element
            delete temp;
        }
    }
...
void DoubleLinkedList::removeByValue(const string& value, string& removedElement) {
